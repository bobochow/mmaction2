...
# model settings
model = dict(
    backbone=dict(type='ViT_CLIP_VPT',drop_path_rate=0.2, adapter_scale=0.5, num_frames=32,num_adapter=1),
...
total_epochs = 30
num_frames=32
work_dir = './work_dirs/vitclip_vpt_base_hmdb51'
train_pipeline = [
...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend',init_kwargs=dict(project='vitclip_vpt_base_hmdb51', name='exp_32f_4_apex')),
    ],
)
