...
# model settings
model = dict(
    backbone=dict(drop_path_rate=0.2, adapter_scale=0.5, num_frames=32,with_t_cls_token=True,linear_adapter=True,bottleneck=128,share_adapter=False),
...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend',init_kwargs=dict(project='vitclip_zeroI2V_base_hmdb51', name='exp_ths_t_CLS_linear128_apex')),
    ],
)
