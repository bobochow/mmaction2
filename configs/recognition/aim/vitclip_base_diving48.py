...
total_epochs = 50
work_dir = './work_dirs/vitclip_base_diving48'
train_pipeline = [
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=total_epochs, val_begin=1, val_interval=5)
...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend',init_kwargs=dict(project='vitclip_diving48', name='vitclip_base_diving48')),
    ],
)
