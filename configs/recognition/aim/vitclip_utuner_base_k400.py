...
ann_file_train = 'data/kinetics400/train_videos_list.txt'
ann_file_val = 'data/kinetics400/val_videos_list.txt'
ann_file_test = 'data/kinetics400/val_videos_list.txt'

num_frames=16
total_epochs = 5
work_dir = './work_dirs/vitclip_tps_utuner_k400'
train_pipeline = [
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=total_epochs, val_begin=4, val_interval=1)
...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend',init_kwargs=dict(project='vitclip_utuner_base_k400', name='exp1')),
    ],
)
