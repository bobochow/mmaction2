_base_ = [
    '../../_base_/models/vitclip_dualpath_base.py', '../../_base_/default_runtime.py'
]
# model settings
model = dict(
    backbone=dict(drop_path_rate=0.1, adapter_scale=0.5, num_frames=32),
...
total_epochs = 50
work_dir = './work_dirs/vitclip_dualpath_base_hmdb51'
train_pipeline = [
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type='AdamW', lr=3e-2, betas=(0.9, 0.999), weight_decay=0.02),
    paramwise_cfg=dict(
...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend',init_kwargs=dict(project='vitclip_dualpath_base_hmdb51', name='exp1')),
    ],
)
